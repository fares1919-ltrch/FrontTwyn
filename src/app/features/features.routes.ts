...
import { ProcessAuditTrailComponent } from './audit/process-audit-trail.component';
import { AuditComponent } from './audit/audit.component';
import { StarterComponent } from './dashboard/starter.component';
...
export const FeaturesRoutes: Routes = [
  {
    ...
    children: [
      ...
      {
        path: 'process-audit-trail',
        component: ProcessAuditTrailComponent,
        canActivate: [RoleGuard],
        data: { roles: [UserRole.Admin, UserRole.SuperAdmin] }
      }
    ],
